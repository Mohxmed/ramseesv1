        ...
        right={
          <>
            ...
            <button
              ...
              className="rounded-md border border-line px-4 py-2 text-xs font-medium text-foreground transition-colors hover:border-surface-3 hover:text-foreground disabled:opacity-50"
            >
